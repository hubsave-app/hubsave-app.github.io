...
replacements = {
    ...
    'تحميل تيك توك بدون علامة مائية': 'Download TikTok Without Watermark',
    'حمّل فيديوهات تيك توك بدون علامة مائية': 'Download TikTok Videos Without Watermark',
    'أفضل تطبيق لتحميل فيديوهات تيك توك بجودة عالية بدون علامة مائية. حمّل الآن مجاناً لأجهزة Android.': 'Best app to download TikTok videos in high quality without watermark. Download now for free on Android.',
    'المميزات': 'Features',
    'المدونة': 'Blog',
    'اتصل بنا': 'Contact Us',
    ...
    'أسرع وأسهل طريقة لتحميل فيديوهات وصوتيات تيك توك بجودة عالية مجاناً لأجهزة Android': 'The fastest and easiest way to download TikTok videos and audio in high quality for free on Android.',
    'تحميل مجاني — APK مباشر': 'Free Download — Direct APK',
    'اكتشف المميزات': 'Discover Features',
    'الصق رابط تيك توك هنا...': 'Paste TikTok link here...',
